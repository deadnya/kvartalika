            ...
            <div className={styles.topFooter}>
                <div className={styles.logoAndDescription}>
                    <div className={styles.logo}>
                        ...
                        <span className={styles.logoTitle}>Кварталика</span>
                    </div>
                    
                    <span className={styles.description}>Квартиры комфорт-класса в Томске</span>
                </div>
                    ...
                    <div className={styles.contacts}>
                        ...
                        <div className={styles.contactsItems}>
                            <div className={styles.contactItem}>
                                ...
                                <span>Отдел продаж: Томск, площадь Батенькова 2, подъезд 7, этаж 3, офис 310</span>
                            </div>
                            <div className={styles.contactItem}>
                                <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g opacity="0.4">
